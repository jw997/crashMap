...
jq '.features |= sort_by(.attributes.DateTime_ISO) ' traffic_stops_2020.json  >temp/ts_2020.json
...
jq '.features |= sort_by(.attributes.DateTime_ISO) ' traffic_stops_2021.json  >temp/ts_2021.json
...
jq '.features |= sort_by(.attributes.DateTime_ISO) ' traffic_stops_2022.json  >temp/ts_2022.json
...
jq '.features |= sort_by(.attributes.DateTime_ISO) ' traffic_stops_2023.json  >temp/ts_2023.json
...
jq '.features |= sort_by(.attributes.DateTime_ISO) ' traffic_stops_2024.json  >temp/ts_2024.json
...
jq '.features |= sort_by(.attributes.DateTime_ISO) ' traffic_stops_2025.json  >temp/ts_2025.json
